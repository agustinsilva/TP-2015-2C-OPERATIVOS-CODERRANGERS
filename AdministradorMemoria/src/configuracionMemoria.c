...
int32_t conf_es_valida(t_config * td_configuracion)
{
	...
	return (config_has_property(td_configuracion, "PUERTO_ESCUCHA")
		&& config_has_property(td_configuracion, "IP_SWAP")
		&& config_has_property(td_configuracion, "PUERTO_SWAP")
		&& config_has_property(td_configuracion, "MAXIMO_MARCOS_POR_PROCESO")
		&& config_has_property(td_configuracion, "CANTIDAD_MARCOS")
		&& config_has_property(td_configuracion, "TAMANIO_MARCO")
		&& config_has_property(td_configuracion, "ENTRADAS_TLB")
		&& config_has_property(td_configuracion, "TLB_HABILITADA")
		&& config_has_property(td_configuracion, "RETARDO_MEMORIA")
	);
}
